...
//        // Variables
//        private List<MediaTag> audioTags;

//        /// <summary>
//        /// Construct a library checker
//        /// </summary>
//        /// <param name="audioTags"></param>
//        public LibChecker(List<MediaTag> audioTags)
//        {
//            // Notify
//            Console.WriteLine("\nChecking library...");
...
//            foreach (MediaTag tag in audioTags)
//            {
...
//        private int CheckFilename(MediaTag tag)
//        {
//            int totalHits = 0;
...
//        /// <param name="tag">The audio tag to check</param>
//        /// <returns>The number of issues found</returns>
//        private int CheckForUnwanted(MediaTag tag)
//        {
//            int totalHits = 0;
...
//        /// <param name="tag">The audio tag to check</param>
//        /// <returns>The number of issues found</returns>
//        private int CheckForMissing(MediaTag tag)
//        {
...
//        private int CheckAlbumCoverCount(MediaTag tag)
//        {
//            try
//            {
...
//        private int CheckProperty(MediaTag tag, Func<MediaTag, string> propExt,
...
//        private bool IsExceptionToRules(MediaTag tag, string unwanted)
//        {
...
//            int totalHits = 0;
//            foreach (MediaTag tag in artistAudioTags)
//            {
...
//            int totalHits = 0;
//            foreach (MediaTag tag in musivAudioTags)
//            {
...
//        private void HandleLibCheckerException(Exception ex, MediaTag tag, 
...
//        private List<MediaTag> FilterTagsByMainFolder(string mainFolderName)
//        {
...
//        private string GetFileName(MediaTag tag)
//        {
...
//        private string GetDirectParentFolder(MediaTag tag)
//        {
//            string[] pathParts = GetPathParts(tag);
...
//        private string GetRelPathPart(MediaTag tag, int pos)
//        {
...
//        private string[] GetPathParts(MediaTag tag)
//        {
